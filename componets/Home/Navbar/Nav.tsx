    ...
    <div className={`transition-all ${
      ...
      <div className='flex items-center h-full justify-between w-[90%] mx-auto'> 
        ...
        <div className='flex items-center space-x-3'>
            ...
            <h1 className='text-xl hidden sm:block md:text-2xl text-white font-bold'> Anshaar </h1>
        </div>
        <div className='hidden lg:flex items-center space-x-10'>
            {Navlinks.map((link) => {
                return (
                    ...
                    key={link.id}
                    href={link.url}
                    className='text-base hover:text-red-300 text-white font-medium transition-all duration-200'
                    >
                        <p>{link.Label}</p>
                    </Link>
                );
